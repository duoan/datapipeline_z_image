...
def main():
    ...
    parser.add_argument("--features_path", type=str, required=True, help="Path to feature file (numpy array or pickle)")
    ...
    trainer = KMeansTrainer(n_clusters=args.n_clusters, random_state=args.random_state)
    _ = trainer.train(features)  # Model stored in trainer, returned value not used
